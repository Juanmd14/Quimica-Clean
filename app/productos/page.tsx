  ...
  return (
    <div style={{ minHeight: '100vh', background: C.offWhite }}>
      ...
      <div className="qc-page-pad" style={{ background: C.blueDark, padding: '40px 48px', textAlign: 'center' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto 20px', textAlign: 'left' }}>
          <Link href="/" className="qc-back-pill" style={{
            display: 'inline-flex', alignItems: 'center', gap: '8px',
            padding: '8px 16px 8px 12px', borderRadius: '999px',
          ...
          <div style={{ position: 'relative', maxWidth: '420px', marginBottom: '16px' }}>
            ...
            <input
              ...
              style={{
                ...
                border: `1.5px solid ${C.border}`, borderRadius: '999px',
